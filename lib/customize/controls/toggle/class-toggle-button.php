 ...
 * @access public
 */
class Ravon_Toggle_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style(
			'ravon-toggle-control-styles',
			get_parent_theme_file_uri( 'lib/customize/controls/toggle/toggle.css' ),
			false,
			$theme_version,
			'all'
		);
		...
		wp_enqueue_script(
			'ravon-toggle-control-scripts',
			get_parent_theme_file_uri( 'lib/customize/controls/toggle/toggle.js' ),
			array( 'jquery' ),
			$theme_version,
			true
		);
